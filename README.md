...
> Answer: Client-side routing loads everything first and than dynamically changes what is needed instead of receiving a new document each time. 
- [ ] What does AJAX stand for?
> Answer: Asynchronous JavaScript and XML
- [ ] What are `controlled components` in React?
> Answer: Controlled components are the components that have some functionality build-in to them to modify the state. 
